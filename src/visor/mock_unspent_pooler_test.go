...
func (_m *MockUnspentPooler) GetUnspentHashesOfAddrs(_a0 *dbutil.Tx, _a1 []cipher.Address) (AddressHashes, error) {
	ret := _m.Called(_a0, _a1)

	var r0 AddressHashes
	if rf, ok := ret.Get(0).(func(*dbutil.Tx, []cipher.Address) AddressHashes); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(AddressHashes)
		}
	}
